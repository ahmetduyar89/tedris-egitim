...
const RevenueOverview: React.FC<RevenueOverviewProps> = ({ tutorId, students }) => {
    ...
    return (
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 h-full flex flex-col overflow-hidden">
            <div className="p-3 border-b border-gray-100 bg-gradient-to-r from-emerald-500 to-green-600 text-white flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                <h2 className="text-sm font-bold font-poppins flex items-center gap-2">
                    <span className="text-base bg-white/20 p-1 rounded-md">💰</span>
                    Gelir Takibi
                </h2>

                <div className="flex bg-black/10 rounded-lg p-1 backdrop-blur-sm self-start sm:self-auto">
                    <button
                        onClick={() => setSelectedView('summary')}
                        className={`px-2 py-1 rounded text-[10px] font-medium transition-all ${selectedView === 'summary'
                    ...
                    <button
                        ...
                        className={`px-2 py-1 rounded text-[10px] font-medium transition-all ${selectedView === 'students'
                            ? 'bg-white text-emerald-800 shadow-sm'
                            : 'text-white/80 hover:text-white hover:bg-white/10'
                            }`}
                    >
                    ...
                    <button
                        ...
                        className={`px-2 py-1 rounded text-[10px] font-medium transition-all ${selectedView === 'weekly'
                            ? 'bg-white text-emerald-800 shadow-sm'
                            : 'text-white/80 hover:text-white hover:bg-white/10'
                            }`}
                    >
